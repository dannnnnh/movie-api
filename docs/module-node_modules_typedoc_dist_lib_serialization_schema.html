...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Module: node_modules/typedoc/dist/lib/serialization/schema</title>
...
<div id="main">
    ...
    <h1 class="page-title">Module: node_modules/typedoc/dist/lib/serialization/schema</h1>
...
<article>
    <div class="container-overview">
            ...
            <div class="description"><p>Contains interfaces which describe the JSON output. Each interface is related to a specific type of serializer.</p>
<h2>Plugins</h2>
<p>Plugins which modify the serialization process can use declaration merging
to add custom properties to the exported interfaces.
For example, if your custom serializer adds a property to all <a href="Reflection.html">Reflection</a> objects:</p>
<pre class="prettyprint source lang-ts"><code>declare module 'typedoc/dist/lib/serialization/schema' {
    export interface AbstractReflection {
        myCustomProp: boolean
    }
}
</code></pre>
<p>If a plugin defines a new Model type, ModelToObject will not pick up the serializer type and
the resulting type will not be included in the return type of Serializer.toObject.
To fix this, use declaration merging to augment the <a href="Serializer.html">Serializer</a> class.</p>
<pre class="prettyprint source lang-ts"><code>declare module 'typedoc/dist/lib/serialization/serializer' {
    export interface Serializer {
        toObject(value: CustomModel, obj?: Partial&lt;CustomModel>): CustomOutput
    }
}
</code></pre>
<p>For documentation on the JSON output properties, view the corresponding model.</p></div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="typedoc_dist_lib_serialization_schema.js.html">typedoc/dist/lib/serialization/schema.js</a>, <a href="typedoc_dist_lib_serialization_schema.js.html#line2">line 2</a>
    </li></ul></dd>
...
<footer>
    Documentation generated by <a href="https://github.com/jsdoc/jsdoc">JSDoc 4.0.2</a> on Wed Jun 07 2023 18:32:17 GMT+0200 (Central European Summer Time)
</footer>
