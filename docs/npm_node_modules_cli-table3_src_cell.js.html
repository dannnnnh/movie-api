...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: npm/node_modules/cli-table3/src/cell.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: npm/node_modules/cli-table3/src/cell.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>const { info, debug } = require('./debug');
